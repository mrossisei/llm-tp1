> **Copia para la entrega** (actualizada 21/08). El original vive en la raíz del repositorio
> junto con las 604 corridas crudas (`/resultados`, un JSON por corrida con las 16 métricas por
